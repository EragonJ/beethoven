(function() {
  ...
  */
  ...
  Beethoven.prototype = {
    ...
    */
    ...
    setYoutubeClipURL: function() {
      if (this.isValidClip(this.youtubeClip_id)) {
        this.youtubeClipURL = 'http://www.youtube.com/v/' + this.youtubeClip_id + '?enablejsapi=1&version=3&playerapiid=' + this.youtubePlayer_id;
      } else {
    ...
    */
    perform: function() {
      if (!this.isPerformable()) return false;
      /* 
  ...
  */
  ...
  window.onYouTubePlayerReady = function(youtubePlayer_id) {
    return this.beethoven_ref.onYouTubePlayerReady(youtubePlayer_id);
  };

  window.onYoutubeStateChange = function(state_code) {
